...
export const allButtons = [
  ...
  {key: 'github', label: 'GtiHub', icon: faGithub, placeholder: "github.com/username"},
  {key: 'telegram', label: 'Telegram', icon: faTelegram, placeholder: "t.me/username"},
];
          ...
          {activeButtons.map(b => (
            <div key={b.key} className="mb-4 flex items-center md:flex-nowrap flex-wrap">
              <div className="w-36 flex p-2 gap-2 items-center">
                <FontAwesomeIcon icon={faGripLines} className="handle py-1 cursor-grab text-[#6b7280] hover:text-[#3b82f6]" />
              ...
              <div className="flex grow h-full">
                ...
                <button 
                  ...
                  className="p-2 px-4 cursor-pointer text-[#ef4444] hover:text-[#b91c1c]">
        ...
        <div className="flex flex-row flex-wrap gap-2">
          {availableButtons.map(b => (
            <button 
              ...
              className="flex items-center gap-2 p-2 bg-[#f3f4f6] hover:text-[#2563eb]">
              <FontAwesomeIcon icon={b.icon} />
              <span>{b.label}</span>
